...
Scheme
{
	...
	{
		// base colors
		"Pikles"				"64 190 112 255"
		"White"					"255 255 255 255"
		"OffWhite"				"200 200 200 255"
		"DullTextWhite"			"142 142 142 255"
		"DullWhite"				"0 0 0 255"			//controls background, alpha is unchangeable
	...
	BaseSettings
	{
		...
		ComboBoxButton.ArrowColor		"DullTextWhite"
		...
		Label.TextDullColor				"DullTextWhite"	// the "Label." section deals with the "Say:" part
		Label.TextColor					"DullTextWhite"	
		Label.TextBrightColor				"DullTextWhite"
		Label.SelectedTextColor				"DullTextWhite"
		Label.BgColor					"Blank"
		Label.DisabledFgColor1			"DullTextWhite"
		Label.DisabledFgColor2			"DullTextWhite"
		...
		ListPanel.SelectedOutOfFocusBgColor	"0 0 0 153"
		ListPanel.EmptyListInfoTextColor	"OffWhite"

		Menu.TextColor					"White"
		Menu.BgColor					"0 0 0 153"
		Menu.ArmedTextColor				"White"
		Menu.ArmedBgColor				"Pikles"
		Menu.TextInset					"6"

		Panel.FgColor					"Blank"
		Panel.BgColor					"DullWhite" //main background, must be "DullWhite"
		...
		RadioButton.TextColor			"DullTextWhite"
		...
		SectionedListPanel.TextColor		"DullTextWhite"
		...
		TextEntry.DisabledTextColor	"DullTextWhite"
		...
		MainMenu.Inset				"32"
		MainMenu.Backdrop			"27 27 27 255"
		...
		NewGame.SelectionColor		"Pikles"	[$WIN32]
